...
/////////////////
const BotName = 'RIFHEN BOT'; 
const instagram = 'https://instagram.com/rifhen.id?igshid=ZDdkNTZiNTM='; 
const youtube = 'https://www.youtube.com/@rifhen08'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@rifhen.id')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@rifhen.id`)
})
